...
const FormSchema = Yup.object().shape({
  ...
  type: Yup.string().required('Please select payment method')
});
...
const Payment = ({ shipping, payment, subtotal }) => {
  ...
  const onConfirm = () => {
    displayActionMessage(payment.type +' is not available at this time', 'info');
  };
      ...
      <Formik
        ...
        validate={(form) => {
          if (form.type === 'paypal' || form.type === 'credit') {
            displayActionMessage(form.type +' is not available at this time', 'info');
          }
        }}
        onSubmit={onConfirm}
      >
